...
The module ~causalinf~ provides many functionalities to summarize and report the results, including the assessment of the assumptions, estimation, inference, and sensitivity analysis. Check [[file:../../case-studies/overview/did-card1994minimum/][Case Studies]] for more comprehensive examples.
